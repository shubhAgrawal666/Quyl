    ...
    <div className="w-full animate-fadeIn">
      ...
      <div className="flex flex-wrap gap-3 mb-8">
        ...
        <button
          ...
          className="btn-secondary group bg-white/50 backdrop-blur-xl border border-white/30"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Recent Courses */}
        <div className="lg:col-span-2 card p-6 animate-slideUp bg-white/50 backdrop-blur-xl border border-white/30" style={{animationDelay: '0.3s'}}>
          ...
          <div className="space-y-4">
            {courses.slice(0, 4).map((c) => (
              <div
                key={c._id}
                className="flex gap-4 p-4 rounded-xl bg-white/20 backdrop-blur-xl border-white/30 border hover:border-purple-300 hover:bg-purple-50/30 transition-all group"
              >
                <img
                  src={c.thumbnail}
                  alt={c.title}
        ...
        {/* User Distribution */}
        <div className="card p-6 animate-slideUp bg-white/50 backdrop-blur-xl border border-white/30" style={{animationDelay: '0.4s'}}>
